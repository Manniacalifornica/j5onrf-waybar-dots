...
<p>
  To add blur I'm using 'blur wallpaper effect' for better performance. Everything with transparency will have blur including waybar. If using ml4w, right click on wallpaper icon to sellect wallpaper effect blur 1,2.
</p>
</details>
